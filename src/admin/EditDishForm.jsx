...
const EditDishForm = () => {
  ...
  useEffect(() => {
    const fetchDishById = async () => {
      if (dishId) {
        const res = await fetch(`${BASE_URL}/restaurant/dishes/${dishId}`);
  ...
  const handleSubmit = async (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      const response = await fetch(`${BASE_URL}/restaurant/admin/dishes/edit`, {
        method: "POST",
            ...
            >
              ...
              <div className={styles.formGroup}>
                <label htmlFor="ingredients">
                  Ingredients:(please enter ingredients separated by comma)
                </label>
                <input
                  type="text"
                  id="ingredients"
